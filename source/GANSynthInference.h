...
private:
    ...
    /*
    When N_FFT is 2048, the resulting frequency components (bins) are 1025 (from 0 Hz to 8000 Hz), 
    and GANSynth uses 1024 ([1:1024]) of these, excluding the DC (0 Hz) component, for training and generation.
    */
